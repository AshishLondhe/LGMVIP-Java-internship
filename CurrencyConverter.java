...
public class CurrencyConverter
{
    public static void main(String[] args) 
        {
            double peso = 0.00, dollar = 0.00, euro = 0.00, currency, convert, sar = 0.00, bhd = 0.00 ,INR=0.00;
            ...
            System.out.println("Enter 6: Indian Rupees (INR)");
            System.out.println("\n");
            ...
            if(currency == 1)
            {
                ...
                System.out.println("\n");
                 ...
                 System.out.println("Enter 5: Indian Rupees (INR)");
                 System.out.println("\n");
                ...
                {
                INR = peso * 1.46;
                System.out.println("BHD : "+f.format(INR));
                }
           ...
           //DOLLAR CONVERTED TO ANOTHER CURRENCY
            else if (currency == 2)
            {
                ...
                {
                INR = dollar * 82.60;
                System.out.println("/nBHD : "+f.format(INR));
                }
                else
                System.out.println("Invalid Converter!!");
            }
